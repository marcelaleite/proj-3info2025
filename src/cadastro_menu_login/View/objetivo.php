...
<body id="page-home">
  ...
  <main class="hero-screen" role="main">
    <div class="hero">
      ...
      <br>
      <ul>
        <li>Unir ciência, tecnologia e acessibilidade em um único ambiente digital, oferecendo recursos que tornam o estudo da genética mais prático e interativo.</li>
        <li>Facilitar a compreensão dos padrões de herança genética por meio de ferramentas de simulação que permitem explorar cenários hipotéticos e visualizar a transmissão de características ao longo das gerações.</li>
        <li>Proporcionar a criação de árvores genealógicas digitais, organizadas e interativas, que conectam ancestrais e descendentes de forma clara, atendendo tanto a objetivos acadêmicos quanto pessoais.</li>
